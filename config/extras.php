...
*/
 ...
 // INFORMAÇÕES SOBRE O VENDEDOR
  ...
  define('STORE_OWNER_EMAIL_ADDRESS','pafemar@pafemar.com.br');/*usado no banner oferta*/
  define('STORE_EMAIL_TESTE','vendasteste@websitecommerce.com.br');
  define('STORE_ADDRESS','Egidio Thome, 1373');/*usado no banner oferta*/
  define('STORE_ADDRESS_EMAIL','R. Egídio Thomé 1373 - Trê Lagoas/MS - CEP 79604-170');
  define('STORE_BAIRRO','Bairro Vila Nova');/*usado no banner oferta*/
  ...
  // DEFINIÇÃO PARA CABEÇALHOS
  define ('DIV_WELCOMME',1);
  define ('CITY','São Paulo');
  define ('SLOGAN', 'Ferramentas automotivas a preço justo.');
...
define('NR_STRING_NOME_PRODUTO', '250');
  ...
  define('STORE_ADDRESS_GOOGLE_MAPS','Rua Saldanha Marinho 30, Menino Deus,Porto Alegre, RS');