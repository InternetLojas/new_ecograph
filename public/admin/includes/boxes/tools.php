...
<?php
  ...
  if ($selected_box == 'tools') {
    $contents[] = array('text'  => '<a href="' . tep_href_link(FILENAME_BACKUP) . '" class="menuBoxContentLink">' . BOX_TOOLS_BACKUP . '</a><br>' .
                                   ...
                                   '<a href="' . tep_href_link('frete_transp.php', '', 'NONSSL') . '" class="menuBoxContentLink">Frete por transportadora.</a><br>' .
                                   '<a href="' . tep_href_link('retorno_pd.php', '', 'NONSSL') . '" class="menuBoxContentLink">Pedido Pagamento Digital.</a><br>' .
