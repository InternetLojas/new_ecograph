...
// page title
define('TITLE', 'Administração da Loja');
...
define('ENTRY_PF_PJ', 'Tipo de Cliente:');
define('ENTRY_PF_PJ_ERROR', '&nbsp;<span class="errorText">O preenchimento do Tipo de Cliente é obrigatório.</span>');
define('ENTRY_CPF', 'CPF:');
define('ENTRY_CPF_MIN_ERROR', '&nbsp;<small>Seu CPF deve ter no mínimo ' . ENTRY_CPF_MIN_LENGTH . ' caracteres. <span class="fieldRequired">(formato 000.000.000-00)</span></small>');
define('ENTRY_CPF_MAX_ERROR', '&nbsp;<small>Seu CPF deve ter no máximo ' . ENTRY_CPF_MAX_LENGTH . ' caracteres. <span class="fieldRequired">(formato 000.000.000-00)</span></small>');
define('ENTRY_CPF_ERROR_EXISTE', '&nbsp;<small>CPF já existente!</small>');
define('ENTRY_CPF_CHECK_ERROR', '&nbsp;<small>Número de CPF inválido! <span class="fieldRequired">(formato 000.000.000-00)</span></small></small>');
define('ENTRY_CPF_TEXT', '&nbsp;<small>* (000.000.000-00)</small>');
define('ENTRY_RG', 'R.G.:');
define('ENTRY_RG_MIN_ERROR', '&nbsp;<small>Seu R.G. deve ter no mínimo ' . ENTRY_RG_MIN_LENGTH . ' caracteres. <span class="fieldRequired">(formato 00.000.000-0)</span></small>');
define('ENTRY_RG_MAX_ERROR', '&nbsp;<small>Seu R.G. deve ter no máximo ' . ENTRY_RG_MAX_LENGTH . ' caracteres. <span class="fieldRequired">(formato 00.000.000-0)</span></small>');
define('ENTRY_RG_ERROR_EXISTE', '&nbsp;<small>R.G. já existente!</small>');
define('ENTRY_RG_CHECK_ERROR', '&nbsp;<small>Número de R.G. inválido! <span class="fieldRequired">(formato 00.000.000-0)</span></small></small>');
define('ENTRY_RG_TEXT', '&nbsp;<small>* (00.000.000-0)</small>');
define('ENTRY_CNPJ', 'CNPJ:');
define('ENTRY_CNPJ_MIN_ERROR', '&nbsp;<small>O CNPJ deve ter no mínimo ' . ENTRY_CNPJ_MIN_LENGTH . ' caracteres. <span class="fieldRequired">(formato 00.000.000/0000-00)</span></small>');
define('ENTRY_CNPJ_MAX_ERROR', '&nbsp;<small>O CNPJ deve ter no máximo ' . ENTRY_CNPJ_MAX_LENGTH . ' caracteres. <span class="fieldRequired">(formato 00.000.000/0000-00)</span></small>');
define('ENTRY_CNPJ_ERROR_EXISTE', '&nbsp;<small>CNPJ já existente!</small>');
define('ENTRY_CNPJ_CHECK_ERROR', '&nbsp;<small>Número de CNPJ inválido! <span class="fieldRequired">(formato 00.000.000/0000-00)</span></small></small>');
define('ENTRY_CNPJ_TEXT', '&nbsp;<small>* (formato 00.000.000/0000-00)</small>');
define('ENTRY_IE', 'I.E.:');
define('ENTRY_IE_MIN_ERROR', '&nbsp;<small>A I.E. deve ter no mínimo ' . ENTRY_IE_MIN_LENGTH . ' caracteres. <span class="fieldRequired">(formato 000.000.000.000)</span></small>');
define('ENTRY_IE_MAX_ERROR', '&nbsp;<small>A I.E. deve ter no máximo ' . ENTRY_IE_MAX_LENGTH . ' caracteres. <span class="fieldRequired">(formato 000.000.000.000)</span></small>');
define('ENTRY_IE_ERROR_EXISTE', '&nbsp;<small>I.E. já existente!</small>');
define('ENTRY_IE_CHECK_ERROR', '&nbsp;<small>Número de I.E. inválido! <span class="fieldRequired">(formato 000.000.000.000)</span></small></small>');
define('ENTRY_IE_TEXT', '&nbsp;<small>* (formato 000.000.000.000)</small>');
...
define('ENTRY_STREET_NR_RUA', 'NR:');
define('ENTRY_STREET_ADDRESS_NR_RUA_ERROR', '&nbsp;<span class="errorText">min ' . ENTRY_NR_RUA_MIN_LENGTH . ' caracteres</span>');
define('ENTRY_STREET_COMP_REF', 'Complemento ou referência:');
define('ENTRY_STREET_ADDRESS_COMP_REF_ERROR', '&nbsp;<span class="errorText">min ' . ENTRY_COMP_REF_MIN_LENGTH . ' caracteres</span>');
define('ENTRY_STREET_ADDRESS', 'Endereço:');
define('ENTRY_STREET_COMP_REF', 'Complemento ou referência:');
define('ENTRY_STREET_ADDRESS2', 'CPF:');
define('ENTRY_STREET_ADDRESS3', 'RG:'); 
define('ENTRY_STREET_ADDRESS_ERROR', '&nbsp;<span class="errorText">min ' . ENTRY_STREET_ADDRESS_MIN_LENGTH . ' caracteres</span>');
define('ENTRY_STREET_ADDRESS2_ERROR', ' min ' . ENTRY_STREET_ADDRESS2_MIN_LENGTH . ' caracteres</span>');
define('ENTRY_STREET_ADDRESS3_ERROR', ' min ' . ENTRY_STREET_ADDRESS3_MIN_LENGTH . ' caracteres</span>');
define('ENTRY_SUBURB', 'Distrito:');
...
define('ENTRY_TELEPHONE_DDD', 'DDD:');
define('ENTRY_TELEPHONE_DDD_ERROR', '&nbsp;<span class="errorText">min ' . ENTRY_DDD_MIN_LENGTH . ' caracteres</span>');
define('ENTRY_TELEPHONE_NUMBER', 'Fone:');
...
/**cupom de desconto**/
// Discount Code - start
define('BOX_CATALOG_DISCOUNT_CODE', 'Cupom de desconto');
define('TEXT_DISPLAY_NUMBER_OF_DISCOUNT_CODES', 'Mostrando <b>%d</b> de <b>%d</b> (para <b>%d</b> cupom de descontos)');
// Discount Code - end
?>
