...
class HomeController extends Controller {
    ...
    public function brindes() {
        ...
        return view('home.index')
                        ->with('title', STORE_NAME . ' Brindes sensacionais')
                        ->with('page', 'brindes')
                        ->with('ativo', 'Brindes')
                        ->with('brindes', $categorias->toarray())
                        ->with('rota', '/brindes')
                        ->with('layout', $layout);
    }
    ...
    public function missao() {
        $layout = $this->layout->classes('0');
        return view('home.index')
                        ->with('title', ' Missão da ' . STORE_NAME)
                        ->with('page', 'missao')
                        ->with('ativo', 'Nossa Missão')
                        ->with('rota', '/missao.html')
                        ->with('layout', $layout);
    }
    ...
    public function certificacao() {
        ...
        return view('home.index')
                        ->with('title', ' Missão da ' . STORE_NAME)
                        ->with('page', 'certificacao')
                        ->with('ativo', 'Certificacao')
                        ->with('rota', '/certificacao.html')
                        ->with('layout', $layout);
    }
    ...
    public function comocomprar() {
        ...
        $layout = $this->layout->classes('0');
        return view('home.index')
                        ->with('title', STORE_NAME . ' Como comprar')
                        ->with('page', 'comocomprar')
                        ->with('ativo', 'Como Comprar')
                        ->with('rota', '/comocomprar')
                        ->with('layout', $layout);
    }
