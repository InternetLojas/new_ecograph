...
return array(
    ...
    'attributes' => array('confirmed' => '<b>Confirmação</b>',
        ...
        'zipcode' => 'CEP',
        'uf' => 'Estado',
        'vlDeclarado' => '<b>Preço do produto</b>',
        'customers_firstname' => 'Nome',
        'customers_lastname' => 'Sobrenome',
        'entry_nr_rua' => 'Nº',        
        'customers_gender' => 'Sexo',
        'customers_cpf_cnpj' => 'Sexo',
        'entry_company' => 'Razão Social',
        'entry_fantasia' => 'Nome Fantasia',
        'customers_rg_ie' => 'RG/IE',
        'entry_street_address' => 'Endereço',
        'entry_nr_rua' => 'Nr da Rua',
        'entry_comp_ref' => 'Complemento',
        'entry_suburb' => 'Bairro',
        'entry_city' => 'Cidade',
        'entry_state' => 'Estado',
        'entry_postcode' => 'CEP',
        'customers_telephone' => 'Telefone Fixo',
        'customers_telephone1' => 'Telefone alternativo',
        'customers_cel' => 'Celular principal',
        'customers_cel1' => 'Celular alternativo',
        'email' => 'Email',
        'password' => 'Senha',
