                                ...
                                <table>
                                    <tr>
                                        <td style="text-align:left;padding:5px 10px;">
                                            <h2>Comentário feito para produto</h2>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                        ...
                        <tr>
                            <td width="650" align="left" style="font-family:Verdana,Geneva,sans-serif;font-size:12px !important;line-height:16px">
                                <blockquote style="text-align:justify;line-height:20px;border-left: 10px solid #D1D1D6;  padding: 10px; color: #212121;">
                                    Caro Sr(a). <strong>{{Customer::find(Auth::User()->id)->customers_firstname}}</strong>!<br>
                                    Recebemos seu comentário para o produto <strong>{{ProductDescription::find(Input::get('product_id'))->products_name}}</strong>.<br>
                                    Analisaremos sua sugestão e agradecemos seu interesse.
                                </blockquote>
                            </td>
                        </tr>
                    </tbody>
