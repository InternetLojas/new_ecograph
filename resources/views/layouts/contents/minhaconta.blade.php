                        ...
                        <div class="table-responsive cart_info">
                            <table class="table table-hover">
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td class="center">
                                        <a class="btn btn-success no-radius" href="{{ route('clientes.conta.edit',['id'=> $customers->id])}}" >detalhes</a>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
                            ...
                            <table class="table table-hover">
                                ...
                                @forelse($address as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-success no-radius" href="{{route('clientes.endereco.edit',['id'=>$item->id])}}" title="Ver Detalhes">detalhes</a>
                                        </td>
                                    </tr>
                                @empty
