...
<div class="title_pagina">
    ...
    <div class="title_content">
        <h3><span class="text-medio">Solicitação de Orçamento</span></h3>
    </div>
</div>
...
<div class="row">
    <div style="display:block;margin:auto !important; max-width:650px;padding:15px 0;text-align:center">
        ...
        <div class="col-md-6">
            <a class="btn bg-green fg-white no-radius " title="Clique encaminhar o orçamento por email para a loja" href="javascript:void(0)" id="data_orcamento" data-orcamento="">Imprimir</a>
        </div>
    </div>
</div>
