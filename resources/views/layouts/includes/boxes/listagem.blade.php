    ...
    <div class="thumbnail border no-radius">
        <div class="text-center">
            <div class="thumb_cat bg-transparent text-center">
                ...
                <button type="button" onclick="AdicionarCarrinho('{{$row['original']['id']}}');" class="btn btn-success fg-white no-radius" title="{{ Fichas::nomeProduto($row['original']['id']) }}" id="{{$row['original']['id']}}">
