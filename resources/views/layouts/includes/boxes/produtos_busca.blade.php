            ...
            <div class="thumbnail border no-radius">
                <div class="text-center">
                    <div class="thumb_cat bg-transparent text-center">
                        ...
                        <a href="{{ URL::to('produtos/detalhes') }}/{{Fichas::idparentCategoria($item->id)}}/{{Fichas::idCategoria($item->id) }}/{{ URLAmigaveis::Slug(Fichas::nomeProduto($item->id),'-',true) }}.html" title="{{ Fichas::nomeProduto($item->id) }}" class="btn btn-success fg-white no-radius" title="{{ Fichas::nomeProduto($item->id) }}" id="{{$item->id}}">
