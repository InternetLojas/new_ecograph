...
<form class="form-horizontal" role="form" id="cupom" name="cupom">
        ...
        <div class="input-group">
            <div class="form-group">
                <div class="col-md-3 col-md-push-1">
                    <label class="control-label text-medio  bg-smallgray btn-block" for="discount_code">
                        <span style="text-align:center; padding:5px">Cupom</span>
                    </label>
                </div>
                <div class="col-md-5">                
    ...
    <div class="form-group">
        <!--<button type="button" id="btn_cupom_descartar"></button>-->
