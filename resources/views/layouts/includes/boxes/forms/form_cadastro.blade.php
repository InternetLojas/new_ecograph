<div class="row">
                ...
                <tr>
                    ...
                    <td class="td-content-carrinho">
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">                
                                {!! Form::text('customers_firstname','',  array('id' =>'firstaname', 'class' => 'form-control no-radius', 'placeholder' => 'informe seu nome','required'=>'true')) !!}
                            </div>
                        </div>            
                        <div class="form-group">
                            <div class="col-sm-2">
            ...
            <tbody>
                <tr>
                    ...
                    <td class="td-content-carrinho">
                        ...
                        <div class="form-group">
                            <div class="col-sm-2">
                                <label class="control-label  pull-right" for="entry_fantasia">Nome Fantasia</label>
                            </div>
                            <div class="col-sm-6">   
                                <input id="fantasia" name="entry_fantasia" type="text" class="form-control no-radius" placeholder="nome fantasia" >
                            </div>
    ...
    <!-- DADOS PARA ACESSO-->
    <h3 class="title-cadastro">Dados para acesso</h3>
    <div class="destaque_home_edicao"> 
        <table class="body_cadastro">
            <tbody>
                <tr>
        ...
        <table class="body_cadastro">
            <tbody>
                <tr>
                    ...
                    <td class="td-content-carrinho">
                        <div class="row fluid">
                            <div id="info_cadastro" style="display:none"></div>
                        <div id="mensagem_cadastro" style="display:none"></div>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-2">
                                <label class="control-label pull-right" for="agree">Revendedor</label>
                            </div>
                            <div class="col-sm-6">
                                <div class="checkbox">
                                    <label> 
