<!--<form name="form_edicao" id="form_edicao" method="post" role="form" action="editor/carregar">-->
    ...
    <div class="form-group" data-role="input-control" >
        <input type="tel" name="cel" value="{!!$customers['customers_cel']!!}" class="form-control no-radius" placeholder="Celular" />
    </div>
    <div class="form-group" data-role="input-control" >
        <input type="tel" name="cel1" value="{!!$customers['customers_cel1']!!}" class="form-control no-radius" placeholder="Celular"/>
    </div>
    <div class="form-group" data-role="input-control" >
        <input type="tel" name="fone" value="{!!$customers['customers_telephone']!!}" class="form-control no-radius" placeholder="Telefone"/>
    </div>
    <div class="form-group" data-role="input-control" >
        <input type="tel" name="fone1" value="{!!$customers['customers_telephone1']!!}" class="form-control no-radius" placeholder="Telefone"/>
    </div>
    <div class="form-group" data-role="input-control" >
