...
<div class="form-group">
    ...
    <div class="col-sm-10 fg-dark">
        <input type="tel" class="form-control" placeholder="Seu telefone para contato" id="telefone" value="" name="telefone" required>
    </div>
</div>
<div class="form-group">
    <div class="col-sm-2">
...
<div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
        ...
        <button type="button" id="btn_contato" class="btn btn-default pull-right no-radius fg-dark">Enviar</button>
    </div>
</div>
{!!Form::close()!!}
